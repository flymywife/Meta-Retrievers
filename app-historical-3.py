...
def generate_queries(entity: str, temperature: float) -> Dict[str, str]:
    client = OpenAI()

    categories = [
        "Birth and Family Background: Inquire about their origins, family structure, and early environment.",
        "Education and Formative Experiences: Ask about their educational journey and key early life events that shaped their worldview.",
        "Early Career and Initial Contributions: Focus on their first professional steps and early accomplishments in their field.",
        "Peak Achievements and Recognition: Explore their most significant work, breakthroughs, or periods of greatest influence.",
        " Private Life, Personal Characteristics, and Relationships: Investigate their personality, personal life, and how it interacted with their public persona and work.",
        "Influence and Cultural Impact: Ask about how their work, ideas, or actions have shaped their field, society, or culture. Include questions about both immediate and long-term effects, as well as their current relevance or how they are remembered."
    ]

    prompt = f"""Generate 6 complete, specific, and well-formed questions about the notable figure {entity}. Each question should focus on a different aspect of their life and impact, following these categories:
    ...
    functions = [
        {
            ...
            "parameters": {
                ...
                "properties": {
                    "query_1": {
                        "type": "string",
                        "description": f"A complete, well-formed question about {entity} for the category: {categories[0]}"
                    },
                    "query_2": {
                        "type": "string",
                        "description": f"A complete, well-formed question about {entity} for the category: {categories[1]}"
                    },
                    "query_3": {
                        "type": "string",
                        "description": f"A complete, well-formed question about {entity} for the category: {categories[2]}"
                    },
                    "query_4": {
                        "type": "string",
                        "description": f"A complete, well-formed question about {entity} for the category: {categories[3]}"
                    },
                    "query_5": {
                        "type": "string",
                        "description": f"A complete, well-formed question about {entity} for the category: {categories[4]}"
                    },
                    "query_6": {
                        "type": "string",
                        "description": f"A complete, well-formed question about {entity} for the category: {categories[5]}"
                    }
                },
...
def process_entity(entity: str, max_tokens: int, temperature: float) -> Tuple[Dict, Dict, Dict, Dict, Dict, Dict]:
    ...
    queries = generate_queries(entity, temperature)
    queries_data = {
